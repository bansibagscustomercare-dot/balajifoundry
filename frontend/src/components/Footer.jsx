          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex items-center space-x-2">
                ...
                <a href="tel:+919426082074" className="hover:text-orange-400 transition-colors">
                  (O) 22749351, 22744075 &nbsp;|&nbsp; (M) +91 94260 82074
                </a>
              </div>
              <div className="flex items-center space-x-2">
                <Mail size={16} className="text-orange-500 flex-shrink-0" />
                <a href="mailto:balajifoundry27@gmail.com" className="hover:text-orange-400 transition-colors">
                  balajifoundry27@gmail.com
                </a>
              </div>
              {/* WhatsApp link */}
              <div className="flex items-center space-x-2 pt-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="#f97316" className="flex-shrink-0">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              {[
                ...
                <li key={link.to}>
                  <Link to={link.to} className="hover:text-orange-500 transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start space-x-2">
                ...
                <div>
                  ...
                  <a href="tel:+919426082074" className="block hover:text-orange-400 transition-colors">(M) +91 94260 82074</a>
                </div>
              </li>
              ...
              <li className="pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white text-sm font-medium px-4 py-2 rounded-lg transition-all"
                >
